...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "document", "compositionReady", function(sym, e) {
         ...
         window.parent.parent.SetThisPage(6);
         ...
         soundManager.setup({
         		...
         		onready : function() {
         			loader.addSound('sonido1', 'media/page6.mp3');
         			loader.start();
         		}
         });
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 16086, function(sym, e) {
