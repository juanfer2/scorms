                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            symbolName: 'Symbol_1',
                            type: 'rect',
                            rect: ['42px', '230px', '361', '345', 'auto', 'auto']
                        },
                        {
                            id: 'globo',
                            type: 'image',
                            rect: ['251px', '147px', '693px', '213px', 'auto', 'auto'],
                            opacity: '0',
                        ...
                        },
                        {
                            id: 'titulo',
                            type: 'image',
                            rect: ['326px', '104px', '372px', '33px', 'auto', 'auto'],
                        ...
                        },
                        {
                            ...
                            display: 'none',
                            type: 'rect',
                            rect: ['158px', '301px', '42px', '21px', 'auto', 'auto'],
                        ...
                        },
                        {
                            ...
                            display: 'none',
                            type: 'rect',
                            rect: ['149px', '296px', '25px', '21px', 'auto', 'auto'],
                            fill: ["rgba(210,150,111,1.00)"],
                            stroke: [0,"rgb(0, 0, 0)","none"]
                        },
                        {
                            ...
                            display: 'none',
                            type: 'rect',
                            rect: ['190px', '299px', '10px', '21px', 'auto', 'auto'],
                            fill: ["rgba(210,150,111,1.00)"],
                            stroke: [0,"rgb(0, 0, 0)","none"]
                        },
                        {
                            ...
                            display: 'none',
                            type: 'rect',
                            rect: ['136px', '290px', '87', '36', 'auto', 'auto'],
                            transform: [[],['-12'],[],['0.86111','0.86111']]
                        },
                        {
                            id: 'audioCopy',
                            type: 'image',
