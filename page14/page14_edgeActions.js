...
(function($, Edge, compId){
   var iframe = ''+
   '<iframe class="my_iframe" src="https://test-sao.firebaseapp.com/accounting/expenses?userid='+user_id+'" if="my_iframe" marginwidth="0" marginheight="0" name="ventana_iframe" scrolling="no" border="0"  frameborder="0" width="700" height="550"> '+
   '</iframe> '+
'';
$('#root').html(iframe);
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "document", "compositionReady", function(sym, e) {
         ...
         window.parent.parent.SetThisPage(14);
         ...
         soundManager.setup({
         		...
         		onready : function() {
         			loader.addSound('sonido1', 'media/page14.mp3');
         			loader.start();
         		}
         });
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 22434, function(sym, e) {
         sym.stop();
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 0, function(sym, e) {
         ...
         $("#Stage_contenedor").load('html/_F_Contabilidad_Sesion3.html');
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 382, function(sym, e) {
