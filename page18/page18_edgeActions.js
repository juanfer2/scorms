...
(function($, Edge, compId){
   var iframe = ''+
   '<iframe class="my_iframe" src="https://test-sao.firebaseapp.com/accounting/queryaccounting?userid='+user_id+'" if="my_iframe" marginwidth="0" marginheight="0" name="ventana_iframe" scrolling="yes" border="0"  frameborder="0" width="850" height="550" > '+
   '</iframe> '+
'';
 $('#root').html(iframe);
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "document", "compositionReady", function(sym, e) {
         ...
         window.parent.parent.SetThisPage(18);
         ...
         soundManager.setup({
         		...
         		onready : function() {
         			loader.addSound('sonido1', 'media/page18.mp3');
         			loader.start();
         		}
         });
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 23346, function(sym, e) {
         sym.stop();
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 0, function(sym, e) {
         ...
         $("#Stage_contenedor").load('html/_F_Contabilidad_Sesion5.html');
