...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "document", "compositionReady", function(sym, e) {
         ...
         window.parent.parent.SetThisPage(9);
         ...
         soundManager.setup({
         		...
         		onready : function() {
         			loader.addSound('sonido1', 'media/page9.mp3');
         			loader.start();
         		}
         });
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 2986, function(sym, e) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 14097, function(sym, e) {
