...
//  console.log(API.LMSGetValue('cmi.core.student_id'));
// console.log(SCOGetValue("cmi.core.student_id"));
var user_id = API.LMSGetValue('cmi.core.student_id');
(function($, Edge, compId){
var iframe = ''+
   '<iframe class="my_iframe" src="https://test-sao.firebaseapp.com/accounting/openingbalances?userid='+user_id+'" if="my_iframe" marginwidth="0" marginheight="0" name="ventana_iframe" scrolling="no" border="0"  frameborder="0" width="700" height="500"> '+
   '</iframe> '+
'';
 $('#root').html(iframe);
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "document", "compositionReady", function(sym, e) {
         ...
         window.parent.parent.SetThisPage(10);
         ...
         soundManager.setup({
         		...
         		onready : function() {
         			loader.addSound('sonido1', 'media/page10.mp3');
         			loader.start();
         		}
         });
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 14838, function(sym, e) {
         sym.stop();
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 0, function(sym, e) {
         $("#Stage_contenedor").load('html/_F_Contabilidad_Sesion1.html');
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 335, function(sym, e) {
