        ...
        symbols = {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            symbolName: 'sombra1',
                            type: 'rect',
                            rect: ['465px', '382px', '287', '82', 'auto', 'auto']
                        },
                        {
                            id: 'b1',
                            display: 'none',
                        ...
                        },
                        {
                            id: 'chuloCopy',
                            type: 'image',
                            rect: ['306px', '291px', '59px', '58px', 'auto', 'auto'],
                            fill: ["rgba(0,0,0,0)",im+"chulo.png",'0px','0px']
                        },
                        {
                            id: 'chuloCopy2',
                            type: 'image',
                            rect: ['510px', '285px', '59px', '58px', 'auto', 'auto'],
                            fill: ["rgba(0,0,0,0)",im+"chulo.png",'0px','0px']
                        },
                        {
                            id: 'chuloCopy3',
                            type: 'image',
                            rect: ['690px', '285px', '59px', '58px', 'auto', 'auto'],
                            fill: ["rgba(0,0,0,0)",im+"chulo.png",'0px','0px']
                        }
                    ],
                    style: {
            ...
            "sombra1": {
                ...
                content: {
                    dom: [
                        {
                            ...
                            id: 'RoundRect',
                            opacity: '0',
                            rect: ['-3px', '-1px', '293px', '84px', 'auto', 'auto'],
                    ...
                    style: {
                        '${symbolSelector}': {
                            rect: [null, null, '287px', '82px']
                        }
                    }
                },
                timeline: {
                    duration: 1444.82460095,
                    autoPlay: true,
                    labels: {
                        "ini": 0
                    },
